            ...
            <SVGSection>
              ...
              <SVGSection>
                ...
                <SVGText>
                  ...
                  vector graphics. SVG is essentially to graphics what HTML is
                  to text. SVGs are scalable, meaning they maintain high quality
                  at any size, and are interactive and scriptable, hence ideal
                  for animations.
                </SVGText>
                <SVGText></SVGText>
              </SVGSection>
    ...
    strokeWidth="0.2vh" fill="deeppink" />
              ...
              <SVGSection>
                <SVGText>
                  ...
                  holds the SVG graphics. It acts as a canvas for vector
                  graphics defined inside it.
                </SVGText>
                <SVGText>
                  <HL>width="20vh"</HL>: Sets the width of the SVG canvas to 20
                  viewport heights. This means the SVG's width will be 20% of
                  the viewport height, making it responsive and scaling based on
                ...
                <SVGText>
                  ...
                  namespace for SVG. This is necessary because SVG is an
                  XML-based markup language, and this attribute ensures that the
                  SVG markup is correctly interpreted according to the SVG
                  specification.
                </SVGText>
                <SVGText>
                ...
                <SVGText>
                  ...
                  the center of the circle. Here, it's set to 10 viewport
                  heights, effectively centering the circle horizontally within
                  the 20vh-wide SVG canvas.
                </SVGText>
                <SVGText>
                  <HL>cy="10vh"</HL>: The cy attribute sets the y-coordinate of
                  the center of the circle. Setting it to 10vh centers the
                  circle vertically within the 20vh-tall SVG canvas.
                </SVGText>
                <SVGText>
                  <HL>r="8vh"</HL>: The r attribute specifies the radius of the
                  circle. The circle's radius is 8vh, making the circle's
                  diameter 16vh. This size allows for a margin between the
                  circle and the SVG container edges, given the container's 20vh
                  dimensions.
                </SVGText>{" "}
                <SVGText>
                ...
                <SVGText>
                  ...
                  circle, which is set to a deep pink color. This color fills
                  the interior of the circle.
                </SVGText>
                <SVGText>
                  This SVG example creates a responsive, square-shaped SVG
                  canvas that automatically scales its size based on the
                  viewport's height. Inside this canvas, a circle is drawn,
                  centered both horizontally and vertically, with a cyan stroke
                  around it and filled with a deep pink color. The use of
                  viewport units (vh) for all dimensions ensures that the
                  circle's size and position scale dynamically with changes in
                  the viewport size, maintaining its aspect ratio and
                  positioning within the SVG container.
                </SVGText>
              </SVGSection>
            </SVGSection>
          </VStackFull>
