...
function ParallaxItem({ item }: { item?: React.ReactElement }) {
  return (
    <Box
      style={{
        display: "block",
      }}
      className="p-[2vh] absolute top-[20vh] right-[20vh]"
    >
      {item}
    </Box>
  );
  ...
  return (
    <Flex className="w-screen h-screen bg-radial6op75">
      <Parallax
        ref={parallax}
        pages={6}
        config={{ mass: 1, tension: 350, friction: 60 }}
      >
        <CustomParallaxLayer
          offset={0}
          speed={1}
          className="bg-col-410"
          layerNum="One"
        />
        <ParallaxEmoji speed={2} emoji="dragon" />
        <CustomParallaxLayer
          offset={0.9}
          speed={0.2}
          className="bg-col-510"
          layerNum="Two"
        />
        <CustomParallaxLayer
          offset={2}
          speed={1}
          className="bg-col-610"
          layerNum="Three"
          opacity={0.9}
        />
        {/* 
